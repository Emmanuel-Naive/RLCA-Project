...
Version: 1 ship, 1 goal and n obstacle
...
obst2_center = origin + np.array([UNIT*2, UNIT*5])
obst3_center = origin + np.array([UNIT*5, UNIT*2])
ship1_center = origin + np.array([UNIT * 0, UNIT * 0])
goal1_center = origin + np.array([UNIT * 5, UNIT * 5])
